...
function adicionarItem(vetorHistoricos) {

    JSONHistoricos = JSON.stringify(vetorHistoricos);
    console.log('JSON: ', JSONHistoricos);
    localStorage.setItem('Historicos', JSONHistoricos);
